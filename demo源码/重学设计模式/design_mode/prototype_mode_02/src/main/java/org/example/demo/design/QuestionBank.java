...
import org.example.demo.design.util.Topic;
import org.example.demo.design.util.TopicRandomUtil;
...
public class QuestionBank implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        for (ChoiceQuestion choiceQuestion : choiceQuestionList) {
            ...
            choiceQuestion.setOption(random.getOptionNew());
            choiceQuestion.setKey(random.getKeyNew());
        }
        return questionBank;
    }
